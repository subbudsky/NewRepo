		...
		public class Registee {
			...
			public static void main(String[] args) {
				...
				driver.findElement(By.name ("customer.address.street")).sendKeys("kambhampadu");
				 ...
				 driver.findElement(By.cssSelector("input[name='customer.username']")).sendKeys("subbu"+ Integer.toString(((new Random().nextInt(10))+1)));
				 driver.findElement(By.cssSelector("input[id='customer.password']")).sendKeys("subbu1995");
				 driver.findElement(By.xpath("//input[@id='repeatedPassword']")).sendKeys("subbu1995");
				 driver.findElement(By.xpath("//input[@value='Register']")).click();
				 WebElement msg=driver.findElement(By.xpath("//*[@id=\"rightPanel\"]/p"));
				 String text=msg.getText();
				 if (msg.isEnabled() && text.contains("Your account was created successfully. You are now logged in."))
				 { 
